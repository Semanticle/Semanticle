...
if __name__ == "__main__":
    ...
    dc26_012r = mtdebug.Criteria(methods=['_solve'],notes=['summary']
                                ,targets=[mtutils.Flatfile(path=debug_path
                                                          ,name='DebugOutput_dc26-012r'
                                                          ,type=debug_type)])
    # set debug
   # d = mtdebug.Debug()
...
#    rlt04 = mtrules.Result(request=[[('?sub','?pred','?obj')]])                                               # pass
    rlt04 = mtrules.Result(request=[[('?sub','?pred=ancs_of','?obj>bob')]])                                               # pass

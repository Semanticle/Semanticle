...
if __name__ == "__main__":
    ...
    dc24stress_30be = mtdebug.Criteria(methods=['_solve','_makeKey'],notes=['summary'],
                                       targets=[mtutils.Flatfile(path=debug_path,
                                       name='DebugOutput_dc24stress_30b',
                                       type=debug_type)])
    # set debug
  #  d = mtdebug.Debug()
...
#    d._update(criteria=[dc8f,dc12f,dc7f,dc13f,dc10f,dc14f,dc15f])
 #   d._update(criteria=[dc6,dc20f_dup,dc20f_ok])
  ...
  #  d._update(criteria=[dc24stress_30be])
...
#    s1._actionTriple("add", ('ben', 'from', 'Truro'), 'child_of', 'alice')
    sa._actionTriple('add', 'pa', 'child_of', 'pb')
    sa._actionTriple('add', 'pb', 'child_of', 'pc')
    sa._actionTriple('add', 'pc', 'child_of', 'pa')

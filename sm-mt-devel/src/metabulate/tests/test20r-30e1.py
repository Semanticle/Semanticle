...
if __name__ == "__main__":
    ...
    dc20_30e1 = mtdebug.Criteria(methods=['_makeKey','_solve','_getTIDB'],notes=['summary'],
                            targets=[mtutils.Flatfile(path=debug_path,
                                                      name='dc20_30e1',
                                                      type=debug_type)])
    # set debug
...
#    s1._actionTriple("add", ('ben', 'from', 'Truro'), 'child_of', 'alice')
    sb._actionTriple("add", (['eddy','ender'], 'from', 'Truro'), 'child_of', 'http://www.semanticle.com/triples/#dan')       # add fact to DTS._queryStore b
    sa._actionTriple("add", (['eddyl','enderl'], 'from', 'London'), 'child_of', 'http://www.semanticle.com/triples/#dan')    # add fact to DTS._queryStore a
    sa._actionTriple("add", 'http://www.semanticle.org/triples/#bob', 'child_of', (['andrew','andy'], 'from', 'London'))
    sb._actionTriple("add", 'http://www.semanticle.org/triples/#bob', 'child_of', (['alex','arny'], 'from', 'Truro'))
    sa._actionTriple("add [('http://www.semanticle.org/triples/#bob', 'child_of', 'alice'),('http://www.semanticle.com/triples/#dan', 'child_of', 'cev')]")
    sb._actionTriple("add", [('cev', 'child_of', 'http://www.semanticle.org/triples/#bob'),"('http://www.semanticle.com/triples/#dan', 'child_of', 'cev')"])
    sb._actionTriple("add", 'eve', 'child_of', 'http://www.semanticle.com/triples/#dan')
    ...
    sa._actionTriple("delete", 'cev', 'child_of', 'http://www.semanticle.org/triples/#bob')
    sa._actionTriple("delete", 'cev', 'child_of', 'http://www.semanticle.org/triples/#bob')
...
#    rlt01 = mtrules.Result(request=[[('?person1', "desc_of", ('?person2','from','Truro'))]])                  # pass - unify within nested Query
#    rlt01 = mtrules.Result(request=[[('?person1', "desc_of", "('?person2','from','Truro')")]])                # pass - unify within nested QueryExpression Query
#    rlt01 = mtrules.Result(request=[[('?person1', "desc_of", ('?person2','from',['Truro','London']))]])       # pass - unify within nested Query with QueryElement list
#    rlt01 = mtrules.Result(request=[[('?person1', "desc_of", "('?person2','from',['London','Truro'])")]])     # pass - unify within nested QueryExpression Query with QueryElement list
    rlt01 = mtrules.Result(request=[[('?person1', "desc_of", "?person2=('*','from',['London','Truro'])")]])     # pass - unify to nested QueryExpression Query with QueryElement list

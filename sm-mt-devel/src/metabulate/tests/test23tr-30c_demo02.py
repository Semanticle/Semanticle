...
#    d._update(criteria=[dc8f,dc12f,dc7f,dc13f,dc10f,dc14f,dc15f])
 #   d._update(criteria=[dc5f])
    ...
    sb._actionTriple("add", ['fred','simone'], 'instance_of', 'person')
    sa._actionTriple("add", 'fido', 'instance_of', 'dog')
    sb._actionTriple("add", 'fred', 'has_job_title', 'manager')
    sa._actionTriple("add", 'fred', 'instance_of', 'person')
    sb._actionTriple("add", 'fred', 'instance_of', 'christian_name')
    sa._actionTriple("add", 'jill', 'says', [('fred', 'likes', 'simone'),
                                           ('simon', 'likes', 'simone'),
                                           ('fred', 'likes', 'fred'),
                                           ('fred', 'likes', 'fido')])
    sb._actionTriple("add", ('steven', 'from', 'London'), 'knows', ('fred', 'likes', 'janice'))
